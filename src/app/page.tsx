        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-1.5">
              <h1 className="text-lg sm:text-xl font-black text-white tracking-wider">NEXUS</h1>
              <span className="text-[9px] font-black px-1.5 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 uppercase tracking-widest">
                AI HYBRID
              </span>
            </div>
            <p className="text-[11px] text-zinc-400">
              Konto: <span className="text-emerald-400 font-semibold">{user?.email}</span>
            </p>
          </div>
        </div>
            ...
            <div className="flex gap-2 overflow-x-auto pb-2 w-full no-scrollbar">
              {dniTreningowe.map((dzien: any, idx: number) => (
                <button
                  ...
                  className={`px-3 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition shrink-0 ${wybranyDzienIdx === idx ? 'bg-emerald-600 text-white shadow' : 'bg-zinc-800 text-zinc-400 hover:text-white'}`}
                >
